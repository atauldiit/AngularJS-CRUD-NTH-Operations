...
$query20 = "SELECT * FROM `company_info` WHERE `type` LIKE 'restaurant' AND place != '' AND `place` IS NOT NULL AND `addr` != '' AND `addr` IS NOT NULL AND `city` IS NOT NULL AND `state` IS NOT NULL ORDER BY `id` DESC";
