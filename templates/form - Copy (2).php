...
fclose($myfile); ?> Details Into Database</h3>
		...
		<div class="row oddRow">
			...
			<div class="col-sm-2 col-md-2">
				<div class="form-group">
					...
					<input type="text" name="name" class="form-control" placeholder="Enter Employee Name" ng-model="empInfo.name" value="" autofocus required/>
		...
		<div class="row EvenRow">
			<div class="col-sm-5 col-md-5">
				<div class="form-group">
					...
					<input type="text" name="addr" id="autocomplete" onFocus="geolocate()" class="form-control" placeholder="Enter Address" ng-model="empInfo.addr" value="" autofocus required/>
			...
			<div class="col-sm-3 col-md-3">
				<div class="form-group">
					...
					<input type="text" name="city" id="locality" class="form-control field" placeholder="Enter City" ng-model="empInfo.city" value="" autofocus required/>
			...
			<div class="col-sm-2 col-md-2">
				<div class="form-group slimField">
					...
					<input type="text" name="state" id="administrative_area_level_1" class="form-control field" placeholder="Enter State Name" ng-model="empInfo.state" value="" autofocus required/>
			...
			<div class="col-sm-2 col-md-2">
				<div class="form-group slimField">
					...
					<input type="number" name="zip" id="postal_code" class="form-control field" placeholder="Enter Zip" ng-model="empInfo.zip" value="" autofocus required/>
		...
		<div class="row EvenRow">
			<div class="col-sm-2 col-md-2">
				<div class="form-group">
					<label for="netprice">Price included Breakfast:</label>
			...
			<div class="col-sm-2 col-md-2">
				<div class="form-group">
					<label for="price">판매가 (Price):</label>
			...
			<div class="col-sm-2 col-md-2">
				<div class="form-group">
					<label for="priceR">견적가 (Quote):</label>
		...
		<div class="row oddRow">
			<div class="col-sm-6 col-md-6">
				<div class="row oddRow">
					<label for="price_M">Price Table:</label>
					<div class="col-sm-4 col-md-4">
						<div class="form-group">
							<input type="date" name="PriceDate_1" class="form-control" placeholder="Enter starting Date" ng-model="empInfo.PriceDate_1" value="" autofocus/>
						</div>
					</div>
					<div class="col-sm-4 col-md-4">
						<div class="form-group">
							<input type="date" name="PriceDate_2" class="form-control" placeholder="Enter ending Date" ng-model="empInfo.PriceDate_2" value="" autofocus/>
						</div>
					</div>
					<div class="col-sm-4 col-md-4">
						<div class="form-group">
							<input type="number" name="Price" class="form-control" placeholder="Enter Price" ng-model="empInfo.Price" value="" autofocus/>
						</div>
					</div>
				</div>
			</div>
